#.................................................
#   READ_DATA.PY, v1.0.0, April 2024, Domenico Lanza.
#.................................................
#   This module is needed to read the
#   the data from a  file and to create the the
#   dataframe object.
#.................................................
...
def read_data(program_mode, bash_run):
    ...
    Args:
        ...
        bash_run (string): the bash run command
    ...
    """
    # Variables:
    df_object = None  # Dataframe object
    output_filename = None  # Output filename (string)
    ...
    if (program_mode == 1):  # Single run
        ...
        try:
            df_object, output_filename = read_srun(bash_run)
        ...
        try:
            df_object, output_filename = read_filerun(bash_run)
        except Exception as e:
    ...
    return df_object, output_filename  # Return the dataframe object and the output filename
