#.................................................
#   SYSTEM_SOLVE.PY, v2.0.0, January 2024, Domenico Lanza.
#.................................................
#   This file is needed to solve the linear system
#   in order to use the Newton-Raphson method
#.................................................
import scipy.linalg as linalg #library to solve linear systems
def system_solve(n,A,b): #we define the function system_solve
    ...
    try: #we use a try-except block to handle exceptions
        x=linalg.solve(AA,bb) #we solve the system
    except Exception as e: #if an exception is thrown
        #we inform the user and exit
        print("Error detected in system_solve.py, the linear system cannot be solved.")
        print("linalg.solve function from the scipy library threw an exception:", str(e))
        exit()
